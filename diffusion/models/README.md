...
`UNet.add_depths(...)` appends shape-preserving residual stages to built models
under Keras 3 while retaining existing variables. Training wrappers also update
optimizer and EMA state. `UNetClassifier` adds a feature
